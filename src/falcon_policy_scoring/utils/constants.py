...
POLICY_TYPE_REGISTRY = {
    'prevention': {
        ...
        'device_policies_key': 'prevention',
    ...
    'sensor_update': {
        ...
        'device_policies_key': 'sensor_update',
    ...
    'content_update': {
        ...
        'device_policies_key': 'content_update',
    ...
    'device_control': {
        ...
        'device_policies_key': 'device_control',
    ...
    'it_automation': {
        ...
        'device_policies_key': 'it_automation',
    ...
    'ods_scheduled_scan': {
        ...
        'device_policies_key': None,  # coverage-index based; no device_policies entry
    ...
    'response': {
        ...
        'device_policies_key': 'remote_response',  # API uses 'remote_response' key

...
def build_host_table(host_rows: List[Dict], ctx, config: Dict = None, policy_types: List[str] = None, wide: bool = True) -> Table:
    ...
    # Policy column definitions: (type_key, wide_header, narrow_header, status_key, narrow_width)
    policy_columns = [
        ('prevention',        'Prevention',     'AV',  'prevention_status',        4),
        ('sensor_update',     'Sensor Update',  'SU',  'sensor_update_status',     4),
        ('content_update',    'Content Update', 'CU',  'content_update_status',    4),
        ('firewall',          'Firewall',       'FW',  'firewall_status',          4),
        ('device_control',    'Device Control', 'DC',  'device_control_status',    4),
        ('it_automation',     'IT Automation',  'IT',  'it_automation_status',     4),
        ('ods_scheduled_scan','ODS Scan',       'ODS', 'ods_scheduled_scan_status',4),
        ('response',          'Response (RTR)', 'RTR', 'response_status',          4),
    ]
    ...
    _platform_abbrev = _PLATFORM_ABBREV
